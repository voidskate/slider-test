...
import { Dimensions, StyleSheet, View, Image, Text, TouchableOpacity, Animated, Alert, Touchable } from "react-native";
...
const Slideshow2_Item = ({ img, css, colors }) => {
...
export default Slideshow2_Item;